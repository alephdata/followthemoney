...
Entity streams are read and produced by virtually every part of the [CLI](/guide/cli), the Aleph API, and they're also supported by the ingestors. When stored to disk as a file, the extensions .ftm or .ijson should be used.
