...
<LinkCard label="Read the docs" link="/docs" />

<LinkCard label="Explore the model" link="/explorer" />

<LinkCard label="Learn more about Aleph" link="https://docs.alephdata.org" />
