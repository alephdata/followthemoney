...
class DatesTest(unittest.TestCase):
    ...
    def test_cast_num(self):
        self.assertEqual(dates._cast_num('2017-04-04 10:30:29'), 1491301829.0)
        self.assertEqual(dates._cast_num('2017-04-04 10:30'), 1491301800.0)
        self.assertEqual(dates._cast_num('2017-04-04 10'), 1491300000.0)
        self.assertEqual(dates._cast_num('2017-04-04'), 1491264000.0)
        self.assertEqual(dates._cast_num('2017-4-4'), 1491264000.0)
        self.assertEqual(dates._cast_num('2017-4'), 1491004800.0)
        self.assertEqual(dates._cast_num('2017'), 1483228800.0)
