...
All data stored by the _OpenAleph search engine_ is expressed as FtM entities. OpenAleph itself adds functions for searching, viewing, and manipulating such entities. It also introduces higher-level notions of datasets and access control.

<LinkCard title="Read the docs" link="/docs" />
<LinkCard title="Explore the data model" link="/explorer" />
<LinkCard
  title="Learn more about OpenAleph"
